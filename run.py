import argparse
import torch
from model.exp.exp_main import Exp_Main
import random
import numpy as np
import setproctitle
import wandb
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='IB-guided Transformer-Diffusion')
    ...
    parser.add_argument('--test_batch_size', type=int, default=8, help='batch size of train input data')  
    ...
    parser.add_argument('--seed', type=int, default=1719184442, help='random seed')
